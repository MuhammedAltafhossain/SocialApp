                    ...
                    SizedBox(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.only(
                              ...
                              bottomLeft: Radius.elliptical(width * 0.5, 60)),
                          child: Image.network(
                            'https://images.pexels.com/photos/11743627/pexels-photo-11743627.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                            fit: BoxFit.cover,
                          ),
                        )),
                    const SizedBox(
                    ...
                    SizedBox(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.only(
                              ...
                              bottomLeft: Radius.elliptical(width * 0.5, 60)),
                          child: Image.network(
                            'https://images.pexels.com/photos/1036804/pexels-photo-1036804.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                            fit: BoxFit.cover,
                          ),
                        )),
                    const SizedBox(
